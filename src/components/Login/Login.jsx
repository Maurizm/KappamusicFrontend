...
const Login = () => {
  ...
  return (
    <div className='padre' style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: '#0A100D', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <Slider {...settings}>
      ...
      <div className='card card-body shadow-lg' style={{ backgroundColor: '#0A100D' }}></div>
      <div className='card card-body shadow-lg' style={{ backgroundColor: '#0A100D' }}>
